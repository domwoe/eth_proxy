        ...
        <v-card-text>
          <v-stepper v-model="step" vertical non-linear>
              ...
              <v-card align="center" justify="center" height="200px">
                <v-container fill-height fluid>
                  <v-card-text class="text-center">
                    ...
                    <p v-if="account">ICP Account: {{ icpAccount }}</p>
            ...
            <v-stepper-content step="3">
              ...
              <v-btn color="tertiary" @click="step = 4"> Continue </v-btn>
            </v-stepper-content>
...
import { eth_proxy_shared } from "canisters/eth_proxy_shared";
export default {
  name: 'IndexPage',
  data() {
    return {
  ...
  methods: {
    ...
    async connectWallet() {
      ...
      try {
        ...
        this.icpAccount = await eth_proxy_shared.get_account(this.account);
